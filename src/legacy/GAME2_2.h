...
void sub_487050(struct88* a1_);
void sub_487070(void* lpMem);
void sub_487090(uint32_t** a1);
void sub_4870A0();
int* sub_4870E0(int* a1);
int* sub_487100(int** a1);
struct264* sub_487150(int a1, void* a2);
struct264* sub_4871C0(int a1, int a2, const void* a3);
void sub_4872C0(struct264* lpMem_);
int sub_487310(struct264* a1_);
int* sub_487360(int a1, int** a2, int* a3);
int sub_487590(struct264* a1_, const void* a2);
...
int* sub_4877D0(struct264* a1_, int* a2);
int* sub_4877F0(int** a1);
int* sub_487810(struct264* a1_, int a2);
int sub_487910(struct264* a1_, int a2);
int* sub_487970(struct264* a1_, int a2);
