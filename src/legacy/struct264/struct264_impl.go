...
func (m *Struct264Module) sub_4871C0(a1 int32, a2 int32, a3 unsafe.Pointer) *Struct264 {
	...
	v4 = (*uint32)(v4p)
	alloc.Memset(unsafe.Pointer(v4), 0, 0x108)
	m.sub_425770(unsafe.Pointer(v4))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*64)) = *(*uint32)(unsafe.Pointer(uintptr(v3 + 36)))
	m.nox_common_list_clear_425760((unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*50)))))
	m.sub_4864A0(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*22))))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*54)) = uint32(uintptr(m.sub_4873C0_ptr))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*63)) = 0
	...
	if a3 != nil {
		m.sub_487590((*Struct264)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), a3)
	}
	if ccall.CallIntPtr(*(*unsafe.Pointer)(unsafe.Pointer(uintptr(v3 + 28))), unsafe.Pointer(v4)) == 0 {
		return (*Struct264)(unsafe.Pointer(v4))
	}
	if v4 != nil {
		m.sub_4872C0((*Struct264)(unsafe.Pointer(v4)))
	}
	return nil
}
func (m *Struct264Module) Sub_487150(a1 int32, a2 unsafe.Pointer) *Struct264 {
	...
	if v3 == nil {
		v4 = (*uint32)(unsafe.Pointer(m.sub_4871C0(a1, v6, a2)))
		v3 = v4
		if v4 == nil {
			return nil
		}
		*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*47)) = uint32(v2)
		m.sub_487310((*Struct264)(unsafe.Pointer(v4)))
	}
	*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*4))++
	return (*Struct264)(unsafe.Pointer(v3))
}
func (m *Struct264Module) sub_487310(a1_ *Struct264) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.dword_587000_155144)) + 24)))++
	m.nox_common_list_append_4258E0((unsafe.Pointer(uintptr(uint32(uintptr(*m.dword_587000_155144)) + 12))), (unsafe.Pointer(a1)))
...
func (m *Struct264Module) sub_4872C0(lpMem_ *Struct264) {
	var (
		lpMem unsafe.Pointer = unsafe.Pointer(lpMem_)
		v1    int32
		v2    int32
	)
	m.sub_487910((*Struct264)(unsafe.Pointer(uintptr(int32(uintptr(lpMem))))), -1)
	ccall.CallVoidPtr(*(*unsafe.Pointer)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(lpMem)), 4*5))) + 12))) + 32))), lpMem)
...
func (m *Struct264Module) sub_487810(a1_ *Struct264, a2 int32) *int32 {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(a1_)))
		v2     uint32
		v3     int32
...
func (m *Struct264Module) sub_4877D0(a1_ *Struct264, a2 *int32) *int32 {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(a1_)))
		result *int32
	)
	result = (*int32)(unsafe.Pointer(m.nox_common_list_getFirstSafe_425890((unsafe.Pointer(uintptr(a1 + 200))))))
