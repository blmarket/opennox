...
uint32_t nox_memfile_read(void* dst, uint32_t sz, int32_t cnt, nox_memfile* f);
uint32_t nox_memfile_read64align_40AD60(char* dest, int32_t sz, int32_t cnt, nox_memfile* f);
