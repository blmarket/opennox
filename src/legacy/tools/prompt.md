...
1. find unsafe.Add with:
  - The first operand being `Struct200*` type casted to `unsafe.Pointer` type, and
  - The second operand can be resolved to a constant integer. (Just integer or multiply of integers)
