...
func (m *Struct264Module) sub_4871C0(a1 int32, a2 int32, a3 *[7]uint32) *Struct264 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(a1 + a2*4 + 24))) = uint32(uintptr(unsafe.Pointer(v4m)))
	...
	v4m.field_58 = 0
	v4m.field_62 = 0
	v4m.field_54 = m.externalVars.Sub_4873C0_ptr
	v4m.field_57 = 0
	v4m.field_61 = 0
	v4m.field_59 = 0
	v4m.field_63 = 0
...
func (m *Struct264Module) sub_487310(a1_ *Struct264) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24)))++
	m.nox_common_list_append_4258E0((unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 12))), (unsafe.Pointer(a1_)))
	result = int32(*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) - 1)
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) = uint32(result)
	if result < 0 {
		*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) = 0
	}
	return result
}

func (m *Struct264Module) Sub_431270() {
	if *m.externalVars.Dword_5d4594_805984 != nil {
		m.Sub_487680((*Struct264)(*m.externalVars.Dword_5d4594_805984))
		*m.externalVars.Dword_5d4594_805984 = nil
	}
}
...
func (m *Struct264Module) Sub_431290() {
	if *m.externalVars.Dword_5d4594_805984 != nil {
		m.sub_487970((*Struct264)(*m.externalVars.Dword_5d4594_805984), -1)
	}
}
...
func (m *Struct264Module) sub_4876A0(a1_ *Struct264) unsafe.Pointer {
	...
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24)))++
	...
	result = unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) - 1))
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) = uint32(uintptr(result))
	if int32(uintptr(result)) < 0 {
		result = *m.externalVars.Dword_587000_155144
		*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(*m.externalVars.Dword_587000_155144)) + 24))) = 0
	}
	return result
}
...
func (m *Struct264Module) Sub_452810(a1 int32, a2 int8) *Struct312 {
	...
	v2 = nil
	if *m.externalVars.Dword_5d4594_1045428 != nil {
		v3 = m.sub_487810(*m.externalVars.Dword_5d4594_1045428, 1)
		v2 = v3
		if v3 != nil {
			...
			*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*29)) = int32(uintptr(m.externalVars.Dword_587000_127004))
