...
func (m *AudioModule) Sub_451850(a2p *Struct264, a3p unsafe.Pointer) int32 {
	...
	*m.Externs.Dword_5d4594_1045428 = a2p
	if int32(uintptr(a3p)) != 0 {
		*m.Externs.Dword_5d4594_1045424 = uint32(uintptr(unsafe.Pointer(m.sub_4BD340(int(int32(uintptr(a3p))), 0x100000, 200, 0x2000))))
...
func (m *AudioModule) sub_452580(a1 *Struct576) int32 {
	...
	var ret int32 = 0
	v1p := a1.field_9
	if *(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 192))) == 0 {
		return 0
	}
	v3 = int32(a1.field_75)
	a1.field_109 = 0
	res = (*Struct312)(unsafe.Pointer(m.sub_452810(int(int32(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 48)))+uint32(v3))), 0)))
	a1.field_44 = res
	if res != nil {
		v4 = int32(m.nox_common_randomIntMinMax_415FF0(int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 76)))), int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 80)))), unsafe.Pointer(alloc.InternCString("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c")), 1482))
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 4))))&8 != 0 {
			v5 = int32(m.nox_common_randomIntMinMax_415FF0(int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 68)))), int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 72)))), unsafe.Pointer(alloc.InternCString("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c")), 1497))
			if v5 > 33 {
...
func (m *AudioModule) sub_451E80(a1p *Struct576) int32 {
	...
	v1 = int32(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 36))))
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 4))))
	if *(*int32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) <= 0 {
		v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 192))))
		v4 = 0
		*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) = uint32(v3)
		if v3 > 0 {
			...
			for {
				...
				*(*uint32)(unsafe.Pointer(uintptr(v5 - 4))) = uint32(v6)
				v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))))
				if v4 >= v3 {
					break
				}
			}
	...
	v7 = int32(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) - 1)
	*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) = uint32(v7)
	if (v2 & 2) == 0 {
	...
	v10 = v8
	if v8 < *(*int32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) {
		v11 = (*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + v8*4 + 440)))
		for {
			v10++
			*v11 = *(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*1))
			v11 = (*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*1))
			if v10 >= *(*int32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1p))) + 568))) {
				break
			}
		}
	}
...
func (m *AudioModule) Sub_4519C0() {
	...
	*memmap.PtrUint32(0x5D4594, 1045440)++
	...
	v6 := m.Externs.ListHead_5d4594_840612.next
	v66 := v6.PromoteUnsafe()
	if v6 != m.Externs.ListHead_5d4594_840612 {
		for {
			v7 := v6.next
