...
func (m *AudioModule) sub_452580(a1 *Struct576) int32 {
	...
	var ret int32 = 0
	v1p := a1.field_9
	if *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_48)))) == 0 {
		return 0
	}
	v3 = int32(a1.field_75)
	a1.field_109 = 0
	res = (*Struct312)(unsafe.Pointer(m.sub_452810(int(int32(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_12))))+uint32(v3))), 0)))
	a1.field_44 = res
	if res != nil {
		v4 = int32(m.nox_common_randomIntMinMax_415FF0(int(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_19))))), int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 80)))), unsafe.Pointer(alloc.InternCString("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c")), 1482))
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_1)))))&8 != 0 {
			v5 = int32(m.nox_common_randomIntMinMax_415FF0(int(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_17))))), int(*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1p))) + 72)))), unsafe.Pointer(alloc.InternCString("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c")), 1497))
			if v5 > 33 {
...
func (m *AudioModule) sub_451E80(a1p *Struct576) int32 {
	...
	v1p := a1p.field_9
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_1)))))
	if *(*int32)(unsafe.Pointer(&a1p.field_142)) <= 0 {
		v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(&v1p.field_48)))))
